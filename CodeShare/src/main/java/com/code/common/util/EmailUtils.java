...
import com.code.common.vo.EmailMsg;
...
public class EmailUtils {
	...
	private static MimeMessage createMsg(Session session, String myAccount, EmailMsg msg) {
		...
		try {
			...
			// 3.2设置接收方
			/*
			 * MimeMessage.RecipientType.TO MimeMessage.RecipientType.CC
			...
			// String url = "http://"+ip+":8080/Millet_Shopping/activate?e="+
			// Base64Utils.encode(user.getEmail())+"&c="+Base64Utils.encode(user.getActivatecode());
			// 设置正文信息
